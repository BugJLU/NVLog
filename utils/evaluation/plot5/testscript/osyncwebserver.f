set $dir=/mnt/nvpcssd/ws/
set $nfiles=1000
set $meandirwidth=20
set $filesize=cvar(type=cvar-gamma,parameters=mean:65536;gamma:1.5) #64K
set $nthreads=16
set $iosize=1m
...
define process name=filereader,instances=1
{
  thread name=filereaderthread,memsize=10m,instances=$nthreads
  {
    ...
    flowop appendfilerand name=appendlog,filesetname=logfiles,dsync,iosize=$meanappendsize,fd=2
  }
}
